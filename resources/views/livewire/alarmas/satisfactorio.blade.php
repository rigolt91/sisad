<div wire:poll.5000ms>
    @livewire('breadcrumb', ['links' => [
        ...
        ['title' => 'Satisfactorias', 'url' => ''],
    ]])

    <div class="container-fluid">
        <div class="text-light fw-bold">
            <i class="fa fa-list"></i> {{ __('Alarmas cons estado satiscaforio') }}
        </div>
                ...
                <div class="card bg-dark text-light shadow-sm border-0">
                    <div class="card-header py-1 fw-bold border-primary-bottom">
                        ...
                        <div class="float-start">
                            <select wire:model='dispositivo' class="form-select form-select-sm bg-dark text-light border-secondary shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        @else
                            <div class="text-center">
                                <h5 class="my-4">No hay alarmas satisfactorias para mostrar.</h5>
                            </div>
                        @endif
                    </div>
                </div>
