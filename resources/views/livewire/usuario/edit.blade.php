<div>
    ...
    <div class="container-fluid">
        <div class="text-light fw-bold">
            <i class="fa fa-plus"></i> Editar usuario - {{ $name }}
        </div>
                    ...
                    <div class="card bg-dark text-light shadow">
                        <div class="card-body">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select wire:model='role' class="@error('role') is-invalid border-danger @enderror form-select bg-dark text-secondary" @if($name == 'Administrador') disabled @endif>
